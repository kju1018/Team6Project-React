...
function TreatmentMemo(props) {
  ...
  return (
  <>
    <div className="d-flex row pb-1" style={{height:"50px", backgroundColor:"#FFFFFF"}}><div className="p-2 ml-3 mr-2 text-center" style={{ backgroundColor:"#6790D8", width:"40px", color:"#FFFFFF"}}><i className="bi bi-clipboard-plus"></i></div>진료 메모</div>
