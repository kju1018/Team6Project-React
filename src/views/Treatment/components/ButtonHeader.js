  ...
  return (
    ...
    <style>
      ...
      <div className="row pb-1" style={{height:"50px"}}>
        ...
        <div className="col-2 d-flex align-items-center justify-content-end mr-2" onClick={props.onclick}><i className={`${props.btnicon}`} style={{fontSize: "1.5rem", marginTop:"10px"}}></i></div>
      </div>    
    </>
  );
}
